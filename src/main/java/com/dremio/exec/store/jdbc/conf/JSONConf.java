...
@SourceType(value = "JSONARP", label = "JSON",uiConfig = "json-layout.json")
public class JSONConf extends AbstractArpConf<JSONConf> {
  private static final String ARP_FILENAME = "arp/implementation/json-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.json.JSONDriver";
